...
import { FormulaireReleveComponent } from './releves/formulaire-releve/formulaire-releve.component';
import { ListeSitesComponent } from './sites/liste-sites/liste-sites.component';
import { FormulaireNouveauSiteComponent } from './sites/formulaire-site/formulaire-site.component';
...
export const CHIRO_ROUTES: Routes = [
  ...
  { path: 'releve/nouveau', component: FormulaireReleveComponent },
  { path: 'releve/:uuid', component: FicheReleveComponent },
  { path: 'sites', component: ListeSitesComponent },
  { path: 'site/nouveau', component: FormulaireNouveauSiteComponent },
